...
# Minimal TTS settings storage
def get_tts_settings(user_id: int):
    # Add a simple tts_settings table or store directly in user_settings for simplicity
    # We'll store them in a separate table; if missing, default voice = 'af_sarah', speed=1.0
